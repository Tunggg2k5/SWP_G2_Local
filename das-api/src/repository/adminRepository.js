...
export async function findDashboardRooms() {
  ...
  await populate(rooms, { path: "assignedDentist", select: roomDentistSelect });
  return rooms;
}

export function findWorkingHours() {
  return findMany(COLLECTIONS.clinicWorkingHours, {}, {
...
export function populateClinicRoom(room) {
  return populate(room, { path: "assignedDentist", select: roomDentistSelect });
}
...
export async function updateClinicRoom(roomId, data) {
  ...
  await populate(room, { path: "assignedDentist", select: roomDentistSelect });
  return room;
}
